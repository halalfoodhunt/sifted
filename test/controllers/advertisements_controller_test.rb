...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { commencement_date: @advertisement.commencement_date, expiry_date: @advertisement.expiry_date, name: @advertisement.name, publish: @advertisement.publish }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { commencement_date: @advertisement.commencement_date, expiry_date: @advertisement.expiry_date, name: @advertisement.name, publish: @advertisement.publish }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
